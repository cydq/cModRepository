  ...
  mod.on('enable', () => {
    ...
    document.body.innerHTML += `
      <div id="sbuban-container" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 100000 !important; background-color: black;">
        <button id="startbtn" style="top: 50%; left: 50%; width: 100%; height: 100%;  z-index: 100001 !important;">Start</button>
        <video id="sbuban-jungle" style="display: none; top: 0; left: 0; width: 100%; height: 100%;">
      ...
      video.play().then(() => {
        video.onended = () =>
          document.body.removeChild(
            document.querySelector('#sbuban-container'),
          );
      });
